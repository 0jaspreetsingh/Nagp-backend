...
//		return "Batch [batch_id=" + batch_id + ", activities=" + activities + ", year=" + year + ", technology="
//				+ technology + ", description=" + description + ", qualification_points=" + qualification_points
//				+ ", startdate=" + startdate + ", applicant=" + applicant + "]";
//	}
